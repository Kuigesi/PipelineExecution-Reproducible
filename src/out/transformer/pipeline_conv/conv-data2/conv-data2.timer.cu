...
void Snippet(int x0) {
  ...
  CUDA_CALL(cudaMalloc(&x106, (size_t)(8388608 * sizeof(float))));
  ...
  CUDA_CALL(cudaMalloc(&x119, (size_t)(8388608 * sizeof(float))));
  float* x120 = (float*)malloc(0 * sizeof(float));
  CUDA_CALL(cudaMalloc(&x120, (size_t)(8388608 * sizeof(float))));
  ...
  CUDA_CALL(cudaMalloc(&x126, (size_t)(8388608 * sizeof(float))));
  float* x127 = (float*)malloc(0 * sizeof(float));
  CUDA_CALL(cudaMalloc(&x127, (size_t)(8388608 * sizeof(float))));
  ...
  CUDA_CALL(cudaMalloc(&x133, (size_t)(8388608 * sizeof(float))));
  float* x134 = (float*)malloc(0 * sizeof(float));
  CUDA_CALL(cudaMalloc(&x134, (size_t)(8388608 * sizeof(float))));
  ...
  CUDA_CALL(cudaMalloc(&x140, (size_t)(8388608 * sizeof(float))));
  float* x141 = (float*)malloc(0 * sizeof(float));
  CUDA_CALL(cudaMalloc(&x141, (size_t)(32768 * sizeof(float))));
  ...
  CUDA_CALL(cudaMalloc(&x147, (size_t)(8388608 * sizeof(float))));
  ...
  CUDA_CALL(cudaMalloc(&x149, (size_t)(8388608 * sizeof(float))));
  float* x150 = (float*)malloc(0 * sizeof(float));
  CUDA_CALL(cudaMalloc(&x150, (size_t)(8388608 * sizeof(float))));
  ...
  CUDA_CALL(cudaMalloc(&x152, (size_t)(8388608 * sizeof(float))));
  float* x153 = (float*)malloc(0 * sizeof(float));
  CUDA_CALL(cudaMalloc(&x153, (size_t)(8388608 * sizeof(float))));
  float* x154 = (float*)malloc(0 * sizeof(float));
  CUDA_CALL(cudaMalloc(&x154, (size_t)(8388608 * sizeof(float))));
  ...
  CUDA_CALL(cudaMalloc(&x156, (size_t)(8388608 * sizeof(float))));
  float* x157 = (float*)malloc(0 * sizeof(float));
  CUDA_CALL(cudaMalloc(&x157, (size_t)(32768 * sizeof(float))));
  float* x158 = (float*)malloc(0 * sizeof(float));
  CUDA_CALL(cudaMalloc(&x158, (size_t)(32768 * sizeof(float))));
  ...
  CUDA_CALL(cudaMalloc(&x160, (size_t)(8388608 * sizeof(float))));
  ...
  CUDA_CALL(cudaMalloc(&x162, (size_t)(8388608 * sizeof(float))));
  float* x163 = (float*)malloc(0 * sizeof(float));
  CUDA_CALL(cudaMalloc(&x163, (size_t)(8388608 * sizeof(float))));
  float* x164 = (float*)malloc(0 * sizeof(float));
  CUDA_CALL(cudaMalloc(&x164, (size_t)(8388608 * sizeof(float))));
  ...
  CUDA_CALL(cudaMalloc(&x166, (size_t)(8388608 * sizeof(float))));
  float* x167 = (float*)malloc(0 * sizeof(float));
  CUDA_CALL(cudaMalloc(&x167, (size_t)(8388608 * sizeof(float))));
  ...
  CUDA_CALL(cudaMalloc(&x169, (size_t)(32768 * sizeof(float))));
  float* x170 = (float*)malloc(0 * sizeof(float));
  CUDA_CALL(cudaMalloc(&x170, (size_t)(32768 * sizeof(float))));
  float* x171 = (float*)malloc(0 * sizeof(float));
  CUDA_CALL(cudaMalloc(&x171, (size_t)(32768 * sizeof(float))));
  ...
  CUDA_CALL(cudaMalloc(&x193, (size_t)(8388608 * sizeof(float))));
  ...
  CUDA_CALL(cudaMalloc(&x199, (size_t)(8388608 * sizeof(float))));
  ...
  CUDA_CALL(cudaMalloc(&x206, (size_t)(8388608 * sizeof(float))));
  ...
  CUDA_CALL(cudaMalloc(&x212, (size_t)(8388608 * sizeof(float))));
  ...
  CUDA_CALL(cudaMalloc(&x219, (size_t)(8388608 * sizeof(float))));
  ...
  CUDA_CALL(cudaMalloc(&x225, (size_t)(8388608 * sizeof(float))));
  ...
  CUDA_CALL(cudaMalloc(&x232, (size_t)(8388608 * sizeof(float))));
  ...
  CUDA_CALL(cudaMalloc(&x238, (size_t)(8388608 * sizeof(float))));
  ...
  CUDA_CALL(cudaMalloc(&x245, (size_t)(8388608 * sizeof(float))));
  ...
  CUDA_CALL(cudaMalloc(&x251, (size_t)(8388608 * sizeof(float))));
  ...
  CUDA_CALL(cudaMalloc(&x258, (size_t)(32768 * sizeof(float))));
  ...
  CUDA_CALL(cudaMalloc(&x264, (size_t)(32768 * sizeof(float))));
  ...
  CUDA_CALL(cudaMalloc(&x271, (size_t)(8388608 * sizeof(float))));
  ...
  CUDA_CALL(cudaMalloc(&x277, (size_t)(8388608 * sizeof(float))));
  ...
  CUDA_CALL(cudaMalloc(&x284, (size_t)(8388608 * sizeof(float))));
  ...
  CUDA_CALL(cudaMalloc(&x297, (size_t)(8388608 * sizeof(float))));
  ...
  CUDA_CALL(cudaMalloc(&x303, (size_t)(8388608 * sizeof(float))));
  ...
  CUDA_CALL(cudaMalloc(&x316, (size_t)(8388608 * sizeof(float))));
  ...
  CUDA_CALL(cudaMalloc(&x323, (size_t)(8388608 * sizeof(float))));
  ...
  CUDA_CALL(cudaMalloc(&x329, (size_t)(8388608 * sizeof(float))));
  ...
  while (x50 != 40) {
    ...
    x63<<<dim3(28, 1, 1), dim3(512, 1, 1)>>>(x106, x112, 8388608);
    float x359 = 1.0;
    float x360 = 0.0;
    cudnnConvolutionForward(x7, &x359, x55, x112, x53, x35, x54, x116, x118, x117, &x360, x55, x113);
    x63<<<dim3(28, 1, 1), dim3(512, 1, 1)>>>(x113, x119, 8388608);
    float x361 = 1.0;
    float x362 = 0.0;
    cudnnConvolutionForward(x7, &x361, x55, x119, x53, x38, x54, x123, x125, x124, &x362, x55, x120);
    x63<<<dim3(28, 1, 1), dim3(512, 1, 1)>>>(x120, x126, 8388608);
    float x363 = 1.0;
    float x364 = 0.0;
    cudnnConvolutionForward(x7, &x363, x55, x126, x53, x41, x54, x130, x132, x131, &x364, x55, x127);
    x63<<<dim3(28, 1, 1), dim3(512, 1, 1)>>>(x127, x133, 8388608);
    float x365 = 1.0;
    float x366 = 0.0;
    cudnnConvolutionForward(x7, &x365, x55, x133, x53, x44, x54, x137, x139, x138, &x366, x55, x134);
    x63<<<dim3(28, 1, 1), dim3(512, 1, 1)>>>(x134, x140, 8388608);
    float x367 = 1.0;
    float x368 = 0.0;
    cudnnConvolutionForward(x7, &x367, x55, x140, x98, x47, x54, x144, x146, x145, &x368, x52, x141);
    x10<<<dim3(28, 1, 1), dim3(512, 1, 1)>>>(x147, 0, 8388608);
    x10<<<dim3(28, 1, 1), dim3(512, 1, 1)>>>(x148, 0, 8388608);
    x10<<<dim3(28, 1, 1), dim3(512, 1, 1)>>>(x149, 0, 8388608);
    x10<<<dim3(28, 1, 1), dim3(512, 1, 1)>>>(x150, 0, 8388608);
    x10<<<dim3(28, 1, 1), dim3(512, 1, 1)>>>(x151, 0, 8388608);
    x10<<<dim3(28, 1, 1), dim3(512, 1, 1)>>>(x152, 0, 8388608);
    x10<<<dim3(28, 1, 1), dim3(512, 1, 1)>>>(x153, 0, 8388608);
    x10<<<dim3(28, 1, 1), dim3(512, 1, 1)>>>(x154, 0, 8388608);
    x10<<<dim3(28, 1, 1), dim3(512, 1, 1)>>>(x155, 0, 8388608);
    x10<<<dim3(28, 1, 1), dim3(512, 1, 1)>>>(x156, 0, 8388608);
    x10<<<dim3(28, 1, 1), dim3(512, 1, 1)>>>(x157, 0, 32768);
    x10<<<dim3(28, 1, 1), dim3(512, 1, 1)>>>(x158, 0, 32768);
    x10<<<dim3(28, 1, 1), dim3(512, 1, 1)>>>(x159, 0, 8388608);
    x10<<<dim3(28, 1, 1), dim3(512, 1, 1)>>>(x160, 0, 8388608);
    x10<<<dim3(28, 1, 1), dim3(512, 1, 1)>>>(x161, 0, 8388608);
    x10<<<dim3(28, 1, 1), dim3(512, 1, 1)>>>(x162, 0, 8388608);
    x10<<<dim3(28, 1, 1), dim3(512, 1, 1)>>>(x163, 0, 8388608);
    x10<<<dim3(28, 1, 1), dim3(512, 1, 1)>>>(x164, 0, 8388608);
    x10<<<dim3(28, 1, 1), dim3(512, 1, 1)>>>(x165, 0, 8388608);
    x10<<<dim3(28, 1, 1), dim3(512, 1, 1)>>>(x166, 0, 8388608);
    x10<<<dim3(28, 1, 1), dim3(512, 1, 1)>>>(x167, 0, 8388608);
    x10<<<dim3(28, 1, 1), dim3(512, 1, 1)>>>(x168, 0, 8388608);
    x10<<<dim3(28, 1, 1), dim3(512, 1, 1)>>>(x169, 0, 32768);
    x10<<<dim3(28, 1, 1), dim3(512, 1, 1)>>>(x170, 1, 32768);
